...
exp_dir = '/home/alexandreselani/Desktop/OpenGan/OpenGAN-IC/Experimentos/Cifar10/OpenGan_cifar10ResNet18' # experiment directory, used for reading the init model
...
project_name = 'OpenGan_cifar10' + modelFlag
...
path_to_feat = os.path.join(NOMES.FEATS_DIR.value,"CIFAR",NOMES.RESNET18.value)
...
val_closedset  = torch.load(os.path.join(path_to_feat,"CIFAR_val_features.pt"))
