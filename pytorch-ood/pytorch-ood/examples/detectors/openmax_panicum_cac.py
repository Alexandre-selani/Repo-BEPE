...
def grid_search():
    nomeDataset = "Panicum_cac"
    output_dir = "/home/alexandreselani/Desktop/pytorch-ood/pytorch-ood/experimento_panicum_cac_plantnet/Val/"
    ...
    for alpha in alphas:
        for epsilon in epsilons:
            ...
            filename_csv = f"Results_grid_panicum_tail_{min_tailsize}_{max_tailsize}_eps_{epsilon}_alpha_{alpha}_cac_plantnet.csv"
