...
def grid_search():
    ...
    for alpha in alphas:
        for epsilon in epsilons:
            ...
            registra_metricas = metricLogger(tails,5,organized_dir,predict_unknown_value=0)
...
def test_hiperparameter():
    nomeDataset = "Panicum"
    output_dir = "/home/alexandreselani/Desktop/pytorch-ood/pytorch-ood/teste_metricLogger/Test/"
    os.makedirs(output_dir, exist_ok=True)
    ...
    for alpha in alphas:
        for epsilon in epsilons:
            ...
            for fold in range(5):
                ...
                train_dataloader, val_dataloader = data_manager.load_test(fold,NOMES.PANICUM_PLANTNET_VAL_TRANSFORMS.value), data_manager.load_val(fold,NOMES.PANICUM_PLANTNET_VAL_TRANSFORMS.value)
