...
output_dir = "/home/alexandreselani/Desktop/cac-openset-Dimity/Results/Mnist_omni/ResNet18"
os.makedirs(output_dir, exist_ok=True)

#loading model
net_weights_dir = "/home/alexandreselani/Desktop/Experimento_mnist_omni/ResNet18_cac/ResNet18_mnist_omni_cac.pt"
net = ResNet18_cac(num_classes= num_classes).to(device)
net.load_state_dict(torch.load(net_weights_dir))

#loading training data to adjust anchors
data_manager = Mnist_omni_loader(256, NOMES.RESNET18_MNIST_OMNI_EVAL_TRANSFORMS.value)
...
csv_grid_path = os.path.join(output_dir, "Resultados_grid_cac_resnet.csv")
