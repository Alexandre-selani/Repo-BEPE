...
class Panicum_loader:
    def __init__(self, bs,halfsize=False):
        self.bs = bs
        # Carrega os splits salvos anteriormente
        self.splits = torch.load(NOMES.PANICUM_SPLITS.value, weights_only=False)
        
        self.root_kkc=None
        self.root_uuc=None
        # Caminhos base
        if halfsize == False:
            self.root_kkc = "/home/alexandreselani/Desktop/Experimento_panicum/data/KKC"
            self.root_uuc = "/home/alexandreselani/Desktop/Experimento_panicum/data/UUC"
        elif halfsize==True:
