...
from Modelos.ResNet18_backbone import ResNet18_tinyimgnet_cac
...
# Na instanciação ele calcula a média/desvio das classes conhecidas de cada split e deixa
# as transforms do módulo prontas em data_manager.train_transforms / .eval_transforms.
...
for split in range(N_SPLITS):
    ...
    grafico = AnaliseGraficaVal(f"{model_name}_Split_{split}", "TinyImageNet_cac", dir=split_dir)
    ...
    model_dir = os.path.join(split_dir, f"{NOMES.RESNET18.value}_TinyImageNet_cac_split_{split}.pt")
