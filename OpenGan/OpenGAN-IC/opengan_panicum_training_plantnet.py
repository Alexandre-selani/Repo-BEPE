...
for iteration in range(5):
    ...
    feat_extractor = ResNet18_feature_extraction(2)
    feat_extractor.load_model(torch.load(os.path.join(NOMES.PANICUM_RESNET.value,f"Fold_{iteration}",f"ResNet18_Panicum_fold_{iteration}_plantnet.pt")))
